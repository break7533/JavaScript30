...
const inventors1500 = inventors.filter(inventor => inventor.year < 1600 && inventor.year >= 1500);
...
const inventorsold = inventors.sort(function (a, b) {
    return a.year - b.year;
});

console.table(inventorsold);
...
const totalInstances = data.reduce((transports, item) => {
    if (!transports[item]) {
        transports[item] = 0;
    }
    transports[item]++;
